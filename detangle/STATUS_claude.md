...
- **운영자 게이트(대기)**: (1) corpus-binding **Phase 2**(67b1 anchor+draft default→binding 참조 교체[동작변경]+검색 배선) GO (2) MVP1+corpus-binding 브랜치 main 머지. 운영: 자동폴링/Workflow OFF, 수동 wake.
