...
- ⚠️ 복구앵커: RECONCILE_AUDIT_20260616 + 이 파일 + HANDOFF + 메모리. 철칙: 작업 전 origin/main 대조. 비용캡 $500·크레딧잠금, 서브에이전트 fleet 금지(2-에이전트), 자동폴링 OFF.
